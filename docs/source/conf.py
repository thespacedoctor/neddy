# -*- coding: utf-8 -*-
#
# neddy documentation build configuration file, created by
...
man_pages = [
    ('index', 'neddy', u'neddy Documentation',
     [u'Dave Young'], 1)
]
...
texinfo_documents = [
    ('index', 'neddy', u'neddy Documentation',
     u'Dave Young', 'neddy', 'CL-util to query the NASA/IPAC Extragalactic Database (NED)',
     'Miscellaneous'),
]
